...
public AppUser(String username,String password,String email,String firstName,String lastName,int age,boolean isMale) {
	this();
...
public String toString() {
	return "username=" + username + ", password=" + password + ", email=" + email + ", firstName="
